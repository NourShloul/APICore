  ...
  response.forEach((element) => {
    ...
    row.innerHTML += `
      ...
      <td>${element.product.description}</td>
       <td><button class="btn btn-outline-danger" onclick="deleteProduct(${element.cartItemId})">Delete</button>
       <button class="btn btn-outline-primary" onclick="Update(${element.cartItemId})">Update</button></td>
...
async function Update(id) {
  ...
  var url = `http://localhost:2082/api/CartItems/${id}`;
